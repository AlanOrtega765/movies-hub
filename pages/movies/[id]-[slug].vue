...
const getMovie = async () => {
  const response: Movie = await $fetch(
    `${config.public.apiBaseUrl}/movie/${id}?api_key=${config.public.apiKey}&append_to_response=videos,credits,recommendations&language=es-MX`
  );
  ...
  <div>
    ...
    <div class="relative -top-[15vh] px-4 laptop:w-[70%] laptop:mx-auto">
      ...
      <section>
        ...
        <NuxtLink v-if="movie?.belongs_to_collection" class="block mt-2" to="/">
      ...
      <section>
        ...
        <div class="swiper-container">
          <SwipersCardMoviesRecommendationsSwiper v-if="movie?.recommendations"
            class="mt-2"
