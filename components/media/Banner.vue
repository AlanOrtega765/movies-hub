...
<template>
  <section class="relative h-[50vh] lg:h-[70vh]">
    ...
    >
      <h1
        class="text-2xl md:text-3xl lg:text-5xl max-w-full min-h-fit overflow-hidden lg:overflow-visible whitespace-nowrap text-ellipsis"
      >
      ...
      <p class="text-silver hidden lg:block 2xl:text-lg">
        {{ media.overview }}
      </p>
    </div>
  </section>
